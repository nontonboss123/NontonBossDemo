    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <div className="pt-28 max-w-md mx-auto px-6">
        ...
        <form onSubmit={onSubmit} className="space-y-4">
          ...
          <button className="w-full p-3 bg-red-600 rounded font-semibold">Sign Up</button>
        </form>
        <p className="mt-4 text-neutral-300">Already have an account? <Link to="/login" className="text-white underline">Sign in</Link></p>
      </div>
    </div>
  )
}
